...
# isssntervalo de tiempo para cada paso de la simulación
dt = 0.01  
...
while True:
    ...
    theta1 += speed1 * dt * 13000 # Aumenta el factor de velocidad aún más (400)
    theta2 += speed2 * dt * 23400
    theta3 += speed3 * dt * 30090
    theta4 += speed4 * dt * 50000
    theta5 += speed5 * dt * 40003
